...
// Fetch sales returns and allowances data
$result = $conn->query("SELECT * FROM sales_returns_allowances");
...
<head>
    ...
    <title>Sales Returns & Allowances</title>
</head>
<body>
    <h1>Sales Returns & Allowances</h1>
